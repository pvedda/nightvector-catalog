...
The current `catalog-v2` production artifact uses catalog schema version 4 and
contains the complete AT-HYG and OpenNGC datasets. NightVector continues to
support the previous schema-v3 `catalog-v1` release.
